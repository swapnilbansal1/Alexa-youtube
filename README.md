...
7. Delete everything in the text box, and copy in the text from https://raw.githubusercontent.com/swapnilbansal1alexa-youtube/master/InteractionModel.json
